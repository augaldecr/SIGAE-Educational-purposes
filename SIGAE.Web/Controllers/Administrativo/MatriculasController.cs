...
namespace SIGAE.Web.Controllers.Administrativo
{
    public class MatriculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Carnet")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Carnet")] Matricula matricula)
        {
            if (id != matricula.Id)
            {
                return NotFound();
